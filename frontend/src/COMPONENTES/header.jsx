...
function Header() {
  ...
  return (
    <header className="bg-red-800 text-white flex h-20 items-center px-10">
      <div className="max-w-7xl w-full flex justify-between items-center p-4 mx-auto">
        <div className="flex gap-5 items-center">
          ...
          <nav className="flex items-center space-x-8">
            <ul className="flex space-x-8">
              ...
              <li>
                <Link to="/promociones" className="hover:text-gray-300">
                 Promociones 
                </Link>
        ...
        <div className="flex items-center space-x-5 text-nowrap">
          {user ? (
            <div className="flex gap-4 items-center">
              <p>{user.email}</p>
              {user.store ? (
                <Link to="/storepanel" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Mi tienda</Link>
              ) : (
                <Link to="/account" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Cuenta</Link>
              )}
              <button
